...
from schemas.friends_schema import Friend
...
@route.post("/")
def send_friend_request(friend:Friend,db:Session=Depends(get_db),current_user:AuthenticateUser=Depends(get_current_user)):
